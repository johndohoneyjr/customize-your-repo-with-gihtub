...
| **Code review** | Automated first-pass review of pull requests — surfaces bugs, security issues, and convention violations, steered by the same [instruction files](primitive-2-file-based-instructions.md) you use in chat. See [Code Review](code-review.md) for the customization guide. | GitHub.com, VS Code, Visual Studio, JetBrains, Xcode, Eclipse, CLI |
